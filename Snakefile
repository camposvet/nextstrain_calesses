### Setting the rules applicable to all steps that come next. It defines where the input files are: make sure this information is accurate

rule all:
    input:
        auspice_tree = "auspice/Tutorial Nextstrain build for SARS-CoV-2_tree.json",
        auspice_meta = "auspice/Tutorial Nextstrain build for SARS-CoV-2_meta.json"
